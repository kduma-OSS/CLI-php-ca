...
class CACertificateEntity extends BaseEntity
{
    public int $version {
        get => $this->version;
        set { if (isset($this->version)) { throw new \LogicException('Immutable.'); } $this->version = $value; }
    }
    ...
    public CertificateValidity $validity {
        get => $this->validity;
        set { if (isset($this->validity)) { throw new \LogicException('Immutable.'); } $this->validity = $value; }
    }

    public string $subjectKeyIdentifier {
        get => $this->subjectKeyIdentifier;
        set { if (isset($this->subjectKeyIdentifier)) { throw new \LogicException('Immutable.'); } $this->subjectKeyIdentifier = $value; }
    }

    public string $authorityKeyIdentifier {
        get => $this->authorityKeyIdentifier;
        set { if (isset($this->authorityKeyIdentifier)) { throw new \LogicException('Immutable.'); } $this->authorityKeyIdentifier = $value; }
    }

    /** @var BaseExtension[] */
    public array $extensions = [] {
        get => $this->extensions;
        set { if ($this->extensions !== []) { throw new \LogicException('Immutable.'); } $this->extensions = $value; }
    }
    ...
    public bool $isSelfSigned {
        ...
        set { if (isset($this->isSelfSigned)) { throw new \LogicException('Immutable.'); } $this->isSelfSigned = $value; }
    }
